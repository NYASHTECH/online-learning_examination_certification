...
from students.views import announcement, syllabus, lecture_note, policy, lecture, assignment, credit
from students.views import discussion, exam, peer_review, quiz
