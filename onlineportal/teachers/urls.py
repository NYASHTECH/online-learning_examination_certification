...
# Import custom views.
from teachers.views import announcement
from teachers.views import syllabus
from teachers.views import policy
from teachers.views import lecture
from teachers.views import lecture_note
from teachers.views import assignment
from teachers.views import quiz
from teachers.views import exam
from teachers.views import overview
from teachers.views import discussion
from teachers.views import peer_review
from teachers.views import setting
